...
1. - One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/kettle/jem/appraisals/my_class.rb` -> `spec/kettle/jem/appraisals/my_class_spec.rb`.
...
[🧪build]: https://github.com/kettle-rb/kettle-jem-appraisals/actions
[🤝conduct]: https://gitlab.com/kettle-rb/kettle-jem-appraisals/-/blob/main/CODE_OF_CONDUCT.md
